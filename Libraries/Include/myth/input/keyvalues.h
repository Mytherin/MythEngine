...
namespace myth
{
	namespace input
	{
		...
		const keycode MB_LEFT = 0x01;
		const keycode MB_RIGHT = 0x02;
		const keycode MB_MIDDLE = 0x04;
		const keycode MB_SCROLLUP = 0x08;
		const keycode MB_SCROLLDOWN = 0x10;
		const keycode MB_XBUTTON1 = 0x20;
		const keycode MB_XBUTTON2 = 0x21;
		const keycode MB_XBUTTON3 = 0x22;
		const keycode MB_XBUTTON4 = 0x23;
		const keycode MB_XBUTTON5 = 0x24;
		const keycode MB_XBUTTON6 = 0x25;
		const keycode MB_XBUTTON7 = 0x26;
		const keycode MB_XBUTTON8 = 0x27;
		const keycode MB_XBUTTON9 = 0x28;
		const keycode MB_XBUTTON10 = 0x29;
