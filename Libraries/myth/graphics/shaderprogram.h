...
#include <myth\resources\resourcelinks.h>
...
namespace myth
{
	namespace graphics
	{
		...
		*/
		class declspec_graphics ShaderProgram : public myth::resources::Asset
		{
		public:
			//! Empty Constructor
			ShaderProgram(myth::resources::AssetData *assetData, int package);
			//! Destructor
			~ShaderProgram();
		...
		private:
			...
			myth::resources::ResourceLinks<Shader> m_shaders;
